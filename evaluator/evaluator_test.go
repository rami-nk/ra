...
func TestBuiltinFunctions(t *testing.T) {
	tests := []struct {
		...
		{`first([])`, "null"},
		{`first(1)`, "argument to `first` not supported. got=Integer, want=Array."},
		{`first("String")`, "argument to `first` not supported. got=String, want=Array."},
		{`last([1, 2, 3])`, 3},
		{`last(["hallo", 2, 3])`, 3},
		{`last(["hallo", 2, "welt"])`, "welt"},
		{`last([])`, "null"},
		{`last(1)`, "argument to `last` not supported. got=Integer, want=Array."},
		{`last("String")`, "argument to `last` not supported. got=String, want=Array."},
		{`rest([1, 2, 3])`, "[2, 3]"},
		{`rest([])`, "null"},
		{`rest(1)`, "argument to `rest` not supported. got=Integer, want=Array."},
		{`rest("String")`, "argument to `rest` not supported. got=String, want=Array."},
		{`rest(rest([1, 2, 3]))`, "[3]"},
		{`push([1, 2, 3], 4)`, "[1, 2, 3, 4]"},
		{`push([1, 2, 3], [1, 2, 3])`, "[1, 2, 3, [1, 2, 3]]"},
		{`push([1, 2, 3], 4, 4)`, "wrong number of arguments. got=3, want=2."},
		{`let a = [1, 2, 3]; push(a, 4)`, "[1, 2, 3, 4]"},
		{`push(10, 3)`, "argument to `push` not supported. got=Integer, want=Array."},
	}
